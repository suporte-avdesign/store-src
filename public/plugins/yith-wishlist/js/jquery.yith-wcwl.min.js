jQuery( document ).ready( function( $ ){
    ...
    $(document).on( 'click', '.show-title-address', show_title_form );

    $(document).on( 'click', '.wishlist-title-with-address h2', show_title_form );

    $(document).on( 'click', '.hide-title-address', hide_title_form );
    ...
    $(document).on( 'click', '#custom_add_to_cart', function(ev){
        ...
        $( '#yith-wcwl-address' ).load( yith_wcwl_l10n.ajax_url + t.attr( 'href' ) + ' #yith-wcwl-address', {action: yith_wcwl_l10n.actions.bulk_add_to_cart_action}, function(){
    ...
    function print_add_to_cart_notice(){
        ...
        if( messages.length == 0 ){
            $( '#yith-wcwl-address').prepend( yith_wcwl_l10n.labels.added_to_cart_message );
        }
        else{
    ...
    function remove_item_from_wishlist( el ) {
        ...
        $( '#yith-wcwl-address' ).load( yith_wcwl_l10n.ajax_url + ' #yith-wcwl-address', data, function(){
    ...
    function reload_wishlist_and_adding_elem( el, form ) {
        ...
        $.ajax({
            ...
            success: function(res) {
                var obj      = $(res),
                    new_form = obj.find('#yith-wcwl-address'); // get new address
    ...
    /**
     * Show address to edit wishlist title
     *
     * @param ev event
     * @return void
     * @since 2.0.0
    ...
    /**
     * Hide address to edit wishlist title
     *
     * @param ev event
     * @return void
     * @since 2.0.0
    ...
    function hide_title_form( ev ) {
        ...
        t.parents( '.hidden-title-address').hide();
        t.parents( '.hidden-title-address').prev().show ();
    }
