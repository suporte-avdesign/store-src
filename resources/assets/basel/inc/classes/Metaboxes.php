...
class BASEL_Metaboxes {
    ...
    public function posts_categories() {
        ...
        if( basel_new_meta() ) {
             ...
             */
            $cats = new Taxonomy_MetaData_CMB2( 'category', $posts_cat_metaboxes, esc_html__( 'Category Settings', 'basel' ) );     
        }
    ...
    public function product_categories() {
        ...
        if( basel_new_meta() ) {
             ...
             * Instantiate our taxonomy meta class
             */
            $cats = new Taxonomy_MetaData_CMB2( 'product_cat', $product_cat_metaboxes, esc_html__( 'Category Settings', 'basel' ) );  
        }
