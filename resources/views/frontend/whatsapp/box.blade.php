...
<head>
    ...
    <link href="./Condominio Shopping D_files/chat.css" rel="stylesheet" type="text/css" lazyload="">
    <link rel="icon" href="https://ipchat.com.br/sistema/whats-chat-2-0/images/favicon.png" type="image/x-icon">
    ...
    <style type="text/css">
        ...
        -->
        .user-bar{height:40px;background:#005E54;color:#fff;padding:0 8px;font-size:20px;position:relative;z-index:1}
        .send .circle{background:#005E54;border-radius:50%;color:#fff;position:relative;width:40px;height:40px;display:flex;align-items:center;justify-content:center}
    </style><script>
...
<form action="https://ipchat.com.br/sistema/whats-chat-2-0/submit?end_code=ZCRI5GQBNTX9YD2OAU78SW4V6LMK1H0JE3FP20171219164638" method="POST" onsubmit="this.BTEnvia.value=&#39;Enviando...&#39;; this.BTEnvia.disabled=true;">
    <div class="page">
                    ...
                    <div class="cc" id="cc">
                        <div class="user-bar">
                            ...
                            <div class="avatar ubi">
                                <img id="ccp" src="./Condominio Shopping D_files/9KJ1FA2BMC20180402114345.jpg">

                            </div>

                            <div class="name ubi">
                                <span id="ccn" data-userid="1">Shopping D</span>
                                <span id="ccs" class="status">
								Visto: 28/08/2019 às 18:56</span>
                            </div>


                            <div class="actions more ubi">

                                <img src="./Condominio Shopping D_files/+.png" width="27" height="27" border="0" style="margin-right:-15px; margin-top:3px;">
                        ...
                        <div class="conversation">
                            <div class="conversation-container">
                                ...
                                <div class="message received">
                                    Boa tarde! <!---->
                                    <span class="metadata"><span class="time"> 12:09 </span></span>
                                </div>


                                <link rel="stylesheet" href="./Condominio Shopping D_files/confirmacao.css" type="text/css" media="all">
                            ...
                            <div id="conversation-compose" class="conversation-compose" style="bottom:110px; position:fixed; z-index:100; ">
                                ...
                                <button class="send" name="BTEnvia" type="submit">
                                    <div class="circle">
                                        <img src="./Condominio Shopping D_files/enviar_web.png" height="20" border="0">
                                    </div>
                                </button>
                            </div>
                            ...
                            <div style="width:100%; height:25px; background-color:#005E54; bottom:80px; position:fixed; margin-left:0px; margin-right:0px; padding-top:5px; font:Verdana, Geneva, sans-serif; color:#FFFFFF; font-size:10px; text-align:center;">
                                ...
                                <font color="#FFFFFF">Copyright © WhatsCompany</font>
                            </div>
