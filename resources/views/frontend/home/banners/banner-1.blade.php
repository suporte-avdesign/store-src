    ...
    <div class="vc_column-inner">
        <div class="wpb_wrapper">
            <div class="promo-banner cursor-pointer text-center vertical-alignment-top banner- hover-1 color-scheme-light " onclick="window.location.href='#'">
                ...
                <div class="main-wrapp-img">
                    <div class="banner-image">
                        <img class="promo-banner-image image-1 " src="{{asset('faker/banners/home/banner-1.jpg')}}" width="262" height="257" alt="market-banner-small" title="market-banner-small" />
                    </div>
                </div>
            ...
            <div class="promo-banner cursor-pointer text-center vertical-alignment-top banner- hover-1 color-scheme-light " onclick="window.location.href='#'">
                ...
                <div class="main-wrapp-img">
                    <div class="banner-image">
                        <img class="promo-banner-image image-1 " src="{{asset('faker/banners/home/banner-1.jpg')}}" width="262" height="256" alt="market-banner-small-2" title="market-banner-small-2" /> </div>
                </div>
