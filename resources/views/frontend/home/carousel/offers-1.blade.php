<script type="text/javascript">
    jQuery(document).ready(function($) {
        ...
        var owl = $("#carousel-123 .owl-carousel");
...
<div class="vc_row wpb_row vc_row-fluid vc_custom_1477929174010">
                ...
                <div class="promo-banner cursor-pointer text-center vertical-alignment-top banner- hover-1 color-scheme-light" onclick="window.location.href='#'">
                    <div class="main-wrapp-img">
                        <div class="banner-image">
                            <img class="promo-banner-image image-1" src="{{asset('faker/banners/home/featured-1.jpg')}}" width="292" height="420" alt="market-banner-sport" title="market-banner-sport" />
                        </div>
                    </div>
    ...
    <div class="wpb_column vc_column_container vc_col-sm-12 vc_col-lg-9 vc_col-md-12 vc_col-xs-12">
        <div class="vc_column-inner">
            <div class="wpb_wrapper">
                <div class="basel-products-tabs tabs-1155">
                    ...
                    <div class="basel-tab-content" >
                        <div id="carousel-123" class="vc_carousel_container " >
...
<style type="text/css">
    ...
    .basel-products-tabs.tabs-1155 .products-tabs-title .active-tab-title {
        color: #ce0202
    }

    .tabs-1155 .basel-tabs-header {
        border-color: #ce0202
    }
</style>
