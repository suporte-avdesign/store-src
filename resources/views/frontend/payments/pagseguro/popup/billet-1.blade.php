        ...
        <div class="vc_column-inner avd_custom_popup_payment_inner">
            <div class="wpb_wrapper">
                <div class="title-wrapper  basel-title-color-default basel-title-style-default basel-title-size-small text-left ">
                    <div class="images">
                        <img src="{{asset('themes/images/payment/pagseguro.png')}}" alt="PagSeguro" >
                    </div>

                </div>
                <div role="form" class="wpcf7" id="wpcf7-f20165-p29276-o1" lang="en-US" dir="ltr">
                    <div class="screen-reader-response"></div>
                    <form action="/basel/button-with-popup/#wpcf7-f20165-p29276-o1" method="post" class="wpcf7-form" novalidate="novalidate">
                        <div style="display: none;">
                            <input type="hidden" name="_wpcf7" value="20165" />
                            <input type="hidden" name="_wpcf7_version" value="5.1.1" />
                            <input type="hidden" name="_wpcf7_locale" value="en_US" />
                            <input type="hidden" name="_wpcf7_unit_tag" value="wpcf7-f20165-p29276-o1" />
                            <input type="hidden" name="_wpcf7_container_post" value="29276" />
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <div class="info">
                                    <h3> <div class=""> <span>Pagamento com boleto </span> <strong class="total-value">R$ 142,67</strong> </div> <small class="success badge" style="display: none;">0% de desconto! Economize R$ 0,00</small> </h3>
                                    <ul>
                        ...
                        <div class="text-right">
                            <p>
                                <a href="#" title="{{constLang('messages.payments.btn_billet')}}" class="wpcf7-form-control wpcf7-submit btn btn-color-primary">{{constLang('messages.payments.btn_billet')}}</a>
                            </p>
                        </div>
