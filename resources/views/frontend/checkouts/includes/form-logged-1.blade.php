...
<p class="form-row form-row-wide validate-required">
    ...
    <span class="woocommerce-input-wrapper">
        <input type="text" class="input-text" id="address" name="address[address]" autocomplete="off" value="@if(!empty($adresses))$adresses->address @endif" />
    </span>
</p>
...
<p class="form-row form-row-first validate-required">
    ...
    <span class="woocommerce-input-wrapper">
        <input type="text" class="input-text" id="reg_number" name="address[number]" autocomplete="off" value="@if(!empty($adresses))$adresses->number @endif" />
    </span>
</p>
...
<p class="form-row form-row-last">
    ...
    <span class="woocommerce-input-wrapper">
       <input type="text" class="input-text" id="complement" name="address[complement]" autocomplete="off" value="@if(!empty($adresses))$adresses->complement @endif" />
    </span>
</p>
<p class="form-row form-row-first validate-required">
    <label for="district">{{constLang('district')}} <span class="required">*</span></label>
    <span class="woocommerce-input-wrapper">
        <input type="text" class="input-text" id="district" name="address[district]" autocomplete="off" value="@if(!empty($adresses))$adresses->district @endif" />
    </span>
</p>
<p class="form-row form-row-last validate-required">
    <label for="city">{{constLang('city')}} <span class="required">*</span></label>
    <span class="woocommerce-input-wrapper">
        <input type="text" class="input-text" id="city" name="address[city]" autocomplete="off" value="@if(!empty($adresses))$adresses->city @endif" />
    </span>
</p>
...
<p class="form-row form-row-first validate-required">
    ...
    <span class="woocommerce-input-wrapper">
       <input type="text" class="input-text" id="zip_code" name="address[zip_code]" autocomplete="off" value="@if(!empty($adresses))$adresses->zip_code @endif" />
    </span>
</p>
