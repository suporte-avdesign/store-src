        ...
        <div class="container">
            <header class="entry-header">
                ...
                <div class="breadcrumbs" xmlns:v="http://rdf.data-vocabulary.org/#">
                    ...
                    <span class="current">Carrinho 2</span>
                </div>
            </header>
        </div>
    </div>
                        ...
                        <div class="woocommerce">
                            <div class="woocommerce-notices-wrapper">
                                ...
                                <div class="woocommerce-message" role="alert">
                                    "Produto 2" foi removido. <a href="{{route('cart.undo')}}/?undo_item=00a2829b91a876cd2c81122e0ccbd76d&amp;_wpnonce=ead27b4501" class="restore-item">Desfazer?</a>
                                </div>
                                @endif
                            </div>
                            ...
                            @if(empty($cart))
                                ...
                                <div class="basel-empty-cart-text">Antes de prosseguir para o checkout, você deve adicionar alguns produtos ao seu carrinho de compras.
                                    <br> Você encontrará muitos produtos interessantes em nossa página "Loja".</div>
                            ...
                            @else
                                <form class="woocommerce-cart-form" action="{{route('cart.update')}}" method="post">
                                    <table class="shop_table shop_table_responsive cart woocommerce-cart-form__contents" cellspacing="0">
                                        ...
                                        <tr class="woocommerce-cart-form__cart-item cart_item">
                                            <td class="product-remove">
                                                <a href="{{route('cart.endpoint')}}?item=00a2829b91a876cd2c81122e0ccbd76d&_wpnonce=194ce587c0&ajax=remove_item&_token={{csrf_token()}}" class="remove" aria-label="Remover este item" data-product_id="19531" data-product_sku="">&times;</a>
                                            </td>
                                            <td class="product-thumbnail">
                                                <a href="{{route('product', [$product['category'], $product['section'], $product['slug']])}}">
                                            ...
                                            <td class="product-quantity" data-title="Quantidade">
                                                <div class="quantity">
                                                    ...
                                                    <label class="screen-reader-text" for="quantity_5cc1031f454f3">Quantidade</label>
                                                    <input
                                                            type="number"
                                                            id="quantity_5cc1031f454f3"
                                                            class="input-text qty text"
                                                            step="1"
                                                            min="0"
                                                            max=""
                                                            name="cart[00a2829b91a876cd2c81122e0ccbd76d][qty]"
                                                            value="4"
                                                            title="Qtd"
                                                            size="4"
                                                            pattern="[0-9]*"
                                                            inputmode="numeric"
                                                            aria-labelledby="Produto 2 - Preto/Amarelo"
                                                    />
                                    ...
                                    <div class="row cart-actions">
                                        <div class="col-md-6">
                                            <div class="coupon">
                                                <label for="coupon_code">Cupon de desconto:</label>
                                        ...
                                        <div class="col-md-6">
                                            <button type="submit" class="button" name="update_cart" value="Update cart">Atualizar Carrinho</button>
                                            <input type="hidden" id="woocommerce-cart-nonce" name="woocommerce-cart-nonce" value="194ce587c0" />
...
<script type="text/javascript" src="{{asset('plugins/cart/js/cart.js')}}?ver=3.5.4"></script>
