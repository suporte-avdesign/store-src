                                        ...
                                        <div class="u-column2 col-2 col-register">
                                            ...
                                            <form method="post" class="woocommerce-form woocommerce-form-register register">
                                                <p class="woocommerce-FormRow woocommerce-FormRow--wide form-row form-row-wide">
                                                    <label for="reg_username">Usúario&nbsp;<span class="required">*</span></label>
                                                ...
                                                <p class="woocommerce-FormRow form-row">
                                                    <input type="hidden" id="_wpnonce" name="_wpnonce" value="f2e73182b2" />
                                                    <input type="hidden" name="_wp_http_referer" value="{{route('login')}}" />
                                                    <button type="submit" class="woocommerce-Button button" name="register" value="Cadastre-se">Cadastre-se</button>
                                                </p>
