<div class="woocommerce-notices-wrapper"></div>
    <div id="product-19531" class="product-quick-view single-product-content post-19531 type-product status-publish has-post-thumbnail product_cat-woman product first instock featured shipping-taxable purchasable product-type-variable has-default-attributes">
...
'
                        ...
                        <div class="single_variation_wrap">
                            ...
                            <div class="woocommerce-variation-add-to-cart variations_button">
                                <div class="quantity">
                                    ...
                                    <label class="screen-reader-text" for="quantity_5cba5290f0a69">Quantidade</label>
                                    <input
                                            type="number"
                                            id="quantity_5cba5290f0a69"
                                            ...
                                            pattern="[0-9]*"
                                            inputmode="numeric"
                                            aria-labelledby="Quantidade do prduto" />
                    ...
                    <div class="product_meta">
                        <span class="sku_wrapper">OUTRAS INFORMAÇÕES: <span class="sku">N/T</span></span>
